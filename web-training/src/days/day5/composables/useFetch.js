...
export function useFetch(url) {
  ...
  // The actual request. Extracted into a function so it can be re-run
  // by the "Retry" button (extension) as well as on mount.
  ...
  // TODO 7: Return the three refs (plus retry() for re-fetching on failure)
